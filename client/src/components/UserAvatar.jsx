    ...
    <>
      <div>
        <Menu as='div' className='relative inline-block text-left'>
          <div>
            <MenuButton className='w-10 h-10 2xl:w-12 2xl:h-12 items-center justify-center rounded-full bg-purple-600'>
          ...
          >
            <MenuItems className='absolute right-0 mt-2 w-56 origin-top-right divide-gray-100 rounded-md bg-white shadow-2xl ring-1 ring-black/5 focus:outline-none'>
              ...
              {/* if the active option in Headless UI is deprecated should I remove {active} alltogether? */}
                  {({ active }) => (
                    <button
